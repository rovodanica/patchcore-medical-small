...
def run(methods, results_path, gpu, seed, save_segmentation_images, save_roc_pr_curves):
        ...
        with device_context:
            ...
            if save_roc_pr_curves:
                ...
                image_save_path = os.path.join(
                    results_path, "roc_pr_curves", dataset_name
                )
                ...
                patchcore.utils.plot_roc_pr_curves_new(
                    image_save_path,
                    image_scores,
                    pixel_scores,
                    new_pixelwise_retrieval_metrics
                )

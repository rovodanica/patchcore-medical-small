...
!python bin/run_patchcore.py --gpu 0 --seed 0 --save_segmentation_images --save_patchcore_model --save_roc_pr_curves \
...
sampler -p 0.1 approx_greedy_coreset dataset --resize 224 --imagesize 224 -d fastmrixi fastmrixi $datapath

# For more examples, please see patchcore_drive.ipynb.
